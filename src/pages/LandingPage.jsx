    ...
    <div className="min-h-screen bg-gradient-to-b from-emerald-50 to-gray-100">
              ...
              <div className="flex flex-col justify-center space-y-4">
                <div className="space-y-2">
                  ...
                  <p className="max-w-[600px] text-gray-600 md:text-xl">
                    Secure, fast, and easy payments for individuals and
                    businesses. Join thousands of satisfied users today.
                  </p>
                </div>
            ...
            <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
              <Card className="bg-white">
                <CardContent className="p-6 flex flex-col items-center text-center space-y-4">
                  ...
                  <p className="text-gray-600">
                    Seamless experience across all devices, optimized for
                    mobile.
                  </p>
                </CardContent>
              </Card>
              <Card className="bg-white">
                <CardContent className="p-6 flex flex-col items-center text-center space-y-4">
                  ...
                  <p className="text-gray-600">
                    Your transactions are protected with state-of-the-art
                    encryption.
                  </p>
                </CardContent>
              </Card>
              <Card className="bg-white">
                <CardContent className="p-6 flex flex-col items-center text-center space-y-4">
                  ...
                  <p className="text-gray-600">
                    Enjoy low transaction fees and great currency exchange
                    rates.
                  </p>
                </CardContent>
              </Card>
      ...
      <footer className="flex flex-col gap-2 sm:flex-row py-6 w-full shrink-0 items-center px-4 md:px-6 border-t bg-white">
        ...
        <nav className="sm:ml-auto flex gap-4 sm:gap-6">
          <a
            className="text-xs hover:underline underline-offset-4 text-gray-500 hover:text-emerald-600"
            href="#"
          >
            Terms of Service
          </a>
